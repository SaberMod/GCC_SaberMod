...
/* { dg-options "-O2 -ftree-vectorize -fvect-cost-model=dynamic -fdump-tree-vect-details" } */
/* { dg-options "-O2 -ftree-vectorize -fvect-cost-model=dynamic -fdump-tree-vect-details -mno-sse" { target { i?86-*-* x86_64-*-* } } } */
